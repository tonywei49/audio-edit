(function (w, d, PKAE) {
	...
	function PKUI_FX(app) {
		...
		app.listenFor('RequestActionFXUI_Rate', function () {
			...
			var x = new PKAudioFXModal({
				id: filter_id,
				title: PKI18N._t('fx_title_speed', 'Change Speed'),
				presets: [
				...
				buttons: [
					{
						title: PKI18N._t('fx_apply_rate', 'Apply Rate'),
						clss: 'pk_modal_a_accpt',
						callback: function (q) {
							var input = q.el_body.getElementsByTagName('input')[0];
							var value = input.value.trim() / 1;
				...
				body: '<div class="pk_row" style="border:none"><label>' + PKI18N._t('fx_playback_rate', 'Playback Rate') + '</label>' +
		...
		app.listenFor('RequestFXUI_Silence', function () {
			var x = new PKSimpleModal({
				title: PKI18N._t('fx_insert_silence', 'Insert Silence'),
				ondestroy: function (q) {
		...
		app.listenFor('RequestActionFXUI_Compressor', function () {
			...
			var x = new PKAudioFXModal({
				id: filter_id,
				title: PKI18N._t('fx_title_compressor', 'Apply Compression to selected range'),
				clss: 'pk_bigger',
				ondestroy: function (q) {
					app.ui.InteractionHandler.on = false;
					app.ui.KeyHandler.removeCallback(modal_esc_key);
				...
				buttons: [
					{
						title: PKI18N._t('fx_apply', 'Apply'),
						clss: 'pk_modal_a_accpt',
						callback: function (q) {
							var inputs = q.el_body.getElementsByTagName('input');
							var val = getvalue(q);
		...
		app.listenFor('RequestActionFXUI_Normalize', function () {
			...
			var x = new PKSimpleModal({
				title: PKI18N._t('fx_normalize', 'Normalize'),
				ondestroy: function (q) {
					app.ui.InteractionHandler.on = false;
				...
				buttons: [
					{
						title: PKI18N._t('fx_normalize_l_r_equally', 'Normalize Audio'),
						clss: 'pk_modal_a_accpt',
						callback: function (q) {
							var input = q.el_body.getElementsByClassName('pk_horiz')[0];
		...
		app.listenFor('RequestActionFXUI_GraphicEQ', function (num_of_bands) {
			...
			var x = new PKAudioFXModal({
				id: filter_id,
				title: PKI18N._t('fx_eq_title', 'Graphic EQ'),
				...
				buttons: [
					{
						title: PKI18N._t('fx_apply', 'Apply EQ'),
						clss: 'pk_modal_a_accpt',
						callback: function (q) {
							var ranges = q.el_body.getElementsByTagName('input');
		...
		app.listenFor('RequestActionFXUI_HardLimiter', function () {
			...
			var x = new PKAudioFXModal({
				title: PKI18N._t('fx_limiter_title', 'Hard Limiting'),
				ondestroy: function (q) {
					app.ui.InteractionHandler.on = false;
					app.ui.KeyHandler.removeCallback('modalTemp');
				},
		...
		app.listenFor('RequestActionFXUI_Delay', function () {
			...
			var x = new PKAudioFXModal({
				id: filter_id,
				title: PKI18N._t('fx_delay_title', 'Apply Delay to selected range'),
				clss: 'pk_bigger',
				ondestroy: function (q) {
					app.ui.InteractionHandler.on = false;
					app.ui.KeyHandler.removeCallback(modal_esc_key);
		...
		app.listenFor('RequestActionFXUI_Distortion', function () {
			...
			var x = new PKAudioFXModal({
				id: filter_id,
				title: PKI18N._t('fx_title_distortion', 'Apply Distortion to selected range'),
				clss: 'pk_bigger',
				ondestroy: function (q) {
					app.ui.InteractionHandler.on = false;
					app.ui.KeyHandler.removeCallback(modal_esc_key);
				...
				body: '<div class="pk_row"><label class="pk_line">' + PKI18N._t('fx_gain_label', 'Gain') + '</label>' +
		...
		app.listenFor('RequestActionFXUI_Reverb', function () {
			...
			var x = new PKAudioFXModal({
				id: filter_id,
				title: PKI18N._t('fx_reverb_title', 'Apply Reverb to selected range'),
				clss: 'pk_bigger',
				ondestroy: function (q) {
					app.ui.InteractionHandler.on = false;
					app.ui.KeyHandler.removeCallback(modal_esc_key);
